...
const ProjectById = () => {
    ...
    const data: any = projectData(t).projects.find((i: any) => i.id === id)
            ...
            {data &&
                <Grid container py={screenSizeDownMd ? 2 : 8} px={screenSizeDownMd ? screenSizeDownSm ? 2 : 8 : 20} columnSpacing={6} rowSpacing={4} alignItems={'center'}>
                    ...
                    <Grid item xs={12} lg={6}>
                        ...
                        <Grid container mt={2} color={theme.palette.primary.dark} fontSize={'14px'}>
                            <Grid item xs={5} sm={3}>
                                <Typography sx={headerStyle}>{t('collaboration')}</Typography>
                            </Grid>
                            <Grid item xs={1}>
                                <Typography>:</Typography>
                            </Grid>
                            <Grid item xs={6}>
                                {data.collaboration.map((i: any) => <Typography sx={textStyle}>{i}</Typography>)}
                            </Grid>
                        </Grid>
                        {data.tags &&
